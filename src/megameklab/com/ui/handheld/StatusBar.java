...
/**
 * Status bar for handheld weapon construction
 * 
 * @author Neoancient
 *
 */
public class StatusBar extends ITab {
	...
	private static final long serialVersionUID = -4108170992768195912L;
    ...
    public StatusBar(MegaMekLabMainUI parent) {
        ...
        btnValidate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UnitUtil.showValidation(getHandheld(), getParentFrame());
            }
        });
    ...
    public void refresh() {
        ...
        int bv = getHandheld().calculateBattleValue();
        int currentCost = (int)Math.round(getHandheld().getCost(false));

        currentTonnage = getHandheld().getWeight();
    ...
    private void getFluffImage() {
        ...
        */
        ...
        if (fDialog.getFile() != null) {
            ...
            getHandheld().getFluff().setMMLImagePath(relativeFilePath);
        }
